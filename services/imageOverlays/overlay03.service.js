...
async function generateImageOverlay03(options) {
  const {
    base64Data,
    content,
    pageName,
  ...
  try {
    ...
    //  const imagelogo = await loadImage(pageProfileImageUrl);
    // Draw overlay
...
module.exports = { generateImageOverlay03 };