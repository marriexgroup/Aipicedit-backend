...
async function generateImageOverlay23(options) {
  const {
    base64Data,
    content,
    pageName,
...
async function drawOverlay(canvas, ctx, image, content, pageName, colors, noTextOverlay, includePageProfileImage, pageProfileImageUrl) {
  ...
  const wordColors = ['#0af6e8', '#ea1058', '#fff', '#16a0ed', '#FF5E00', '#39FF14', '#FFFF33'];
  const themeColor = wordColors[5];
...
module.exports = { generateImageOverlay23 };